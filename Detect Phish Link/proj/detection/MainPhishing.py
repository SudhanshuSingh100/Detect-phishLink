...
def change_this_function_to_process(url):
    ...
    read = pd.read_csv(r'E:\Detect_Phishing_Website-master\phishing5.txt',header = None,sep = ',')
    read = read.iloc[:,:-1].values
    dataset = pd.read_csv(r'E:\Detect_Phishing_Website-master\Training Dataset1.csv')
